package restful.booker.crudtest;
...
import restful.booker.Steps.BookingSteps;
...
public class BookingCRUDTest extends TestBase {
        static String firstname = "Roma" + TestUtils.getRandomValue();
        ...
        static String additionalneeds = "VeganFood";
        static String token;
        static int id;
    ...
    public void test002() {
        ...
        bookingdates.setCheckout("2024-03-03");
    ...
    public void test005() {
        ...
        Assert.assertThat(update,hasValue("VeganFood") );
    }
